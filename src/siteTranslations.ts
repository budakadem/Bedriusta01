...
const translations: Record<string, Translation> = {
  ...
  ,"İLETİŞİM · BEDRİ USTA MANNHEIM": { DE: "KONTAKT · BEDRİ USTA MANNHEIM", ENG: "CONTACT · BEDRİ USTA MANNHEIM" }
  ,"Sana ulaşmanın en kolay yolu burada.": { DE: "So erreichen Sie uns am einfachsten.", ENG: "The easiest way to reach us." }
  ,"Sorularınız, rezervasyon talepleriniz veya geri bildirimleriniz için bize doğrudan ulaşabilir; adresimizi, çalışma saatlerimizi ve sosyal medya kanallarımızı burada bulabilirsiniz.": { DE: "Für Fragen, Reservierungswünsche oder Feedback erreichen Sie uns direkt; unsere Adresse, Öffnungszeiten und Social-Media-Kanäle finden Sie hier.", ENG: "Reach us directly with your questions, reservation requests or feedback; find our address, opening hours and social media channels here." }
  ,"ADRES · ÇALIŞMA SAATLERİ": { DE: "ADRESSE · ÖFFNUNGSZEITEN", ENG: "ADDRESS · OPENING HOURS" }
  ,"Bize Mannheim şehir merkezinde ulaşabilirsiniz.": { DE: "Sie finden uns im Herzen Mannheims.", ENG: "You can find us in central Mannheim." }
